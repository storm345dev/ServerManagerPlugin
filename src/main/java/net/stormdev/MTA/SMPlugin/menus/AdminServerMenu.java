...
public class AdminServerMenu implements OptionClickEventHandler,Listener<ServerListUpdateEvent>,org.bukkit.event.Listener { //One menu per player accessing it
	private IconMenu menu;
	private String playerName;
	private String title;
	
	public AdminServerMenu(Player player){
	...
	private Server getServer(ItemStack item){
		//TODO
		return null;
	}
